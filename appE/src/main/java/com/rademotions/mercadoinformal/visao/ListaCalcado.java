...
public class ListaCalcado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = mDataBase.retornarListaDados("select * FROM produto where categoria = 'Calçados'");
        listaProduto.clear();
        ...
        grade.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int posicao, long l) {
                ...
                Intent intent = new Intent(ListaCalcado.this, TelaCompra.class);
    ...
    public void onBackPressed() {
        Bundle bundle = new Bundle();
        bundle.putInt("id_cliente",cliente.getId());
        Intent intent = new Intent(ListaCalcado.this, MercadoActivity.class);
        intent.putExtras(bundle);
        startActivity(intent);
    }
}
