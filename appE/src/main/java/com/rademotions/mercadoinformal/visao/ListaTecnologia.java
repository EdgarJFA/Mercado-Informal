...
public class ListaTecnologia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.lista = "Tecnologia";

        Cursor cursor = mDataBase.retornarListaDados("select * FROM produto where categoria = 'Tecnologia'");
        listaProduto.clear();
        ...
        grade.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int posicao, long l) {
                ...
                Intent intent = new Intent(ListaTecnologia.this, TelaCompra.class);
    ...
    public void onBackPressed() {
        Bundle bundle = new Bundle();
        bundle.putInt("id_cliente",cliente.getId());
        Intent intent = new Intent(ListaTecnologia.this, MercadoActivity.class);
        intent.putExtras(bundle);
        startActivity(intent);
    }
}
