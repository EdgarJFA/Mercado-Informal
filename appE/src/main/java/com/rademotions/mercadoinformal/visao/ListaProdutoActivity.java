...
public class ListaProdutoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.lista = "Alimentação";

        Cursor cursor = mDataBase.retornarListaDados("select * FROM produto where categoria = 'Alimentação'");
        listaProduto.clear();
        ...
        grade.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int posicao, long l) {
                ...
                Intent intent = new Intent(ListaProdutoActivity.this, TelaCompra.class);
