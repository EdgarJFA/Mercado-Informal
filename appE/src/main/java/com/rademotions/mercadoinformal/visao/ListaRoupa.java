...
public class ListaRoupa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_roupa);

        grade = (GridView) findViewById(R.id.gridViewProdutoRoupa);
        ...
        Cursor cursor = mDataBase.retornarListaDados("select * FROM produto where categoria = 'Roupa'");
        listaProduto.clear();
        ...
        grade.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int posicao, long l) {
                ...
                Intent intent = new Intent(ListaRoupa.this, TelaCompra.class);
    ...
    public void onBackPressed() {
        Bundle bundle = new Bundle();
        bundle.putInt("id_cliente",cliente.getId());
        Intent intent = new Intent(ListaRoupa.this, MercadoActivity.class);
        intent.putExtras(bundle);
        startActivity(intent);
    }
}
