...
import com.rademotions.mercadoinformal.Adaptador.AdaptadorListaProdutoMoveis;
...
public class ListaProdutoMoveisActivity extends AppCompatActivity {

    GridView grade;
    ArrayList<Produto> listaProduto;
    AdaptadorListaProdutoMoveis adaptador = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adaptador = new AdaptadorListaProdutoMoveis(this,R.layout.activity_lista_produto_item,listaProduto);
        ...
        Cursor cursor = mDataBase.retornarListaDados("select * FROM produto where categoria = 'Movéis'");
        listaProduto.clear();
        ...
        grade.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int posicao, long l) {
                ...
                Intent intent = new Intent(ListaProdutoMoveisActivity.this, TelaCompra.class);
    ...
    public void onBackPressed() {
        Bundle bundle = new Bundle();
        bundle.putInt("id_cliente",cliente.getId());
        Intent intent = new Intent(ListaProdutoMoveisActivity.this, MercadoActivity.class);
        intent.putExtras(bundle);
        startActivity(intent);
    }
}
